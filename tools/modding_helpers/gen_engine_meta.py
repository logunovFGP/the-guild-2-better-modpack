...
NOTES = {
    ...
    'GetSkillValue': [
        "**Uncapped.** `chr_GetSkillValue` is the wrapper that clamps to 15, and only 15",
        "of 152 call sites under Scripts/Measures use it. Any formula dividing a raw",
        "skill and scaling it can run away: ms_021's price was `800 * (1 - skill/100*2)`,",
        "which reaches zero at Bargaining 50 and goes negative above it.",
        "Skill ids come from DB/Skills.dbt: 0 none, 1 constitution, 2 dexterity,",
        "3 charisma, 4 fighting, 5 craftsmanship, 6 shadow_arts, 7 rhetoric, 8 empathy,",
        "9 bargaining, 10 secret_knowledge.",
    ],
    'GetOutdoorLocator': [
