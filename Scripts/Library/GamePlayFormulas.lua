...
function GetDamage(SimAlias, fWeaponDamage)
	...
	local Damage = (fWeaponDamage + (SimGetLevel(SimAlias) + AttackValue) * 0.5) * (1 + AttackValue * 0.025)
	return Damage	
end
...
local list = {GL_BUILDING_TYPE_FARM,GL_BUILDING_TYPE_ROBBER,GL_BUILDING_TYPE_MINE,GL_BUILDING_TYPE_RANGERHUT,GL_BUILDING_TYPE_MERCENARY,GL_BUILDING_TYPE_TOWER,GL_BUILDING_TYPE_DIVEHOUSE,GL_BUILDING_TYPE_JUGGLER,GL_BUILDING_TYPE_FISHINGHUT,GL_BUILDING_TYPE_WAREHOUSE,GL_BUILDING_TYPE_MILL,GL_BUILDING_TYPE_FRUITFARM}
	for i = 1,12 do
