function Run()
	...
	if found == true then
		achievements_Unlock("Actor", "PRIVILEGE_ARREST_SOMEONE")
	elseif AliasExists("ActorDyn") and DynastyGetMember("ActorDyn", 0, "ArrestBoss") then
		achievements_Unlock("ArrestBoss", "PRIVILEGE_ARREST_SOMEONE")
	end
