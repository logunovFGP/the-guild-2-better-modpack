...
function Init()
	...
	if not BuildingIsWorkingTime("Building") then
		MsgBoxNoWait("", "Building", "@L_GENERAL_MEASURES_033_PAYBONUS_FORM_HEAD_+0", "@L_GENERAL_MEASURES_033_PAYBONUS_FAILURES_+2")
		StopMeasure()
	end
	...
	if (numFound == 0) then
		MsgBoxNoWait("", "Building", "@L_GENERAL_MEASURES_033_PAYBONUS_FORM_HEAD_+0", "@L_GENERAL_MEASURES_033_PAYBONUS_FAILURES_+0", GetID("Building"))
		StopMeasure()
	end
...
function Run()
	...
	MsgSay("", "@L_GENERAL_MEASURES_033_PAYBONUS_STATEMENT")
