...
function Run()
	...
	local MusicLevel = 0 
	if Res2==1 then			--Die ber�hmten >Mittell�nder Troubadoure<
		MusicLevel = 4		
	elseif Res2==2 then		--Den bekannten Barden >Willem Hamshakes<
		MusicLevel = 3		
	elseif Res2==3 then		--Eine Truppe Fl�tisten aus den Anden
		MusicLevel = 2		
	elseif Res2==4 then		--Die ber�chtigten >F�rchterlichen Volksmusikanten<
		MusicLevel = 1		
	else
		return
	end		
