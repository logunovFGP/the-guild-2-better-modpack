function Init()
	...
	elseif TypeCount>1 then
		...
		local result = InitData(Buttons,  ms_018_raisecattle_AIInit,
...
function Run()
	...
	ms_018_raisecattle_neuvieh(1)
	LoopAnimation("", "sow_field_loop", 2)
	ms_018_raisecattle_neuvieh(2)
	LoopAnimation("", "sow_field_loop", 2)
	ms_018_raisecattle_neuvieh(3)
	LoopAnimation("", "sow_field_loop", 2)
	ms_018_raisecattle_neuvieh(4)
