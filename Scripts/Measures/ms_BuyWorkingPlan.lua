...
function Run()
	...
	local Elder, Plan, Object
	local ItemName1, ItemCount1, ItemLabel1
	local ItemName2, ItemCount2, ItemLabel2
	local ItemName3, ItemCount3, ItemLabel3
	...
	if not f_BeginUseLocator("GuildClerk", "ClerkPos", GL_STANCE_STAND, true) then
		f_BeginUseLocator("GuildClerk", "ClerkPos", GL_STANCE_STAND, false)
	end
