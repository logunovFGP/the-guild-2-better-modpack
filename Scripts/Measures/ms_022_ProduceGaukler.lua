...
function WorkTable()
	...
	GetPosition("", "MovePos")
	GfxAttachObject("worktable", "city/harbor/worktable.nif")
	GfxSetPositionTo("worktable", "MovePos")
	PlayAnimation("", "manipulate_middle_twohand")
	PlayAnimation("", "talk_short")
	IncrementXPQuiet("", 3) -- xp gain is bugged. Normal gain is 1 xp per 5 ingame minutes, making 12 xp per hour producing. Animation is about 30 sec long
