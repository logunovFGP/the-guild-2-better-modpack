...
function Run()
	...
	-- aufgerufen werden w�rde, was zu vielen Beweisen f�hren w�rde
...
-- -----------------------
-- GetMaxHaulValue 
-- berechnet den maximalen wert der beute, die ein dieb abh�ngig von der geb�udestufe klauen kann
-- -----------------------
