function Weight()
	...
	if not aitwp_FindBeliever("SIM", "Victim", "Victim", 50, "friend", "VictimDynasty2", "Victim2") then
		return 0
	end
	...
	return 25 -- was 100 behind a 1-in-4 dice gate; same expected share, no dice
end
