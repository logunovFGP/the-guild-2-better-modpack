...
function CreateShadowDynasty(Number, City, NewDynastyAlias)
	...
	local PrimTypes = {  GL_BUILDING_TYPE_TAVERN, GL_BUILDING_TYPE_MINE, GL_BUILDING_TYPE_HOSPITAL, -- every village (2) has these 
					...
					GL_BUILDING_TYPE_ROBBER, GL_BUILDING_TYPE_DIVEHOUSE, -- every free city (5) has these 
	...
	local SpouseTypes = { GL_BUILDING_TYPE_FISHINGHUT, GL_BUILDING_TYPE_SMITHY, GL_BUILDING_TYPE_TAILORING, -- most important
				GL_BUILDING_TYPE_BAKERY, GL_BUILDING_TYPE_JOINERY, GL_BUILDING_TYPE_ALCHEMIST_SHOP, GL_BUILDING_TYPE_THIEF, GL_BUILDING_TYPE_STONEMASON, GL_BUILDING_TYPE_DIVEHOUSE,  -- second important
				GL_BUILDING_TYPE_FRIEDHOF, GL_BUILDING_TYPE_BANKHOUSE, GL_BUILDING_TYPE_JUGGLER, GL_BUILDING_TYPE_CASTLE  } -- least important
	...
	if not AliasExists("WorkingHut") then 
		...
		elseif Class == GL_CLASS_SCHOLAR then
			Protos = { GL_BUILDING_TYPE_HOSPITAL, GL_BUILDING_TYPE_ALCHEMIST_SHOP, GL_BUILDING_TYPE_CHURCH_CATH, GL_BUILDING_TYPE_CHURCH_EV, GL_BUILDING_TYPE_BANKHOUSE, GL_BUILDING_TYPE_FRIEDHOF }
			ProtoCount = 6
		else -- rogue
			Protos = { GL_BUILDING_TYPE_THIEF, GL_BUILDING_TYPE_DIVEHOUSE, GL_BUILDING_TYPE_JUGGLER, GL_BUILDING_TYPE_CASTLE }
			ProtoCount = 4
		end
