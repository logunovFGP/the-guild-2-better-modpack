...
function CreateShadowDynasty(Number, City, NewDynastyAlias)
	...
	local SpouseTypes = { GL_BUILDING_TYPE_FISHINGHUT, GL_BUILDING_TYPE_SMITHY, GL_BUILDING_TYPE_TAILORING, -- most important
				...
				GL_BUILDING_TYPE_CRYPT, GL_BUILDING_TYPE_BANKHOUSE, GL_BUILDING_TYPE_JUGGLER, GL_BUILDING_TYPE_MERCENARY  } -- least important
	...
	if not AliasExists("WorkingHut") then 
		...
		elseif Class == GL_CLASS_SCHOLAR then
			Protos = { GL_BUILDING_TYPE_HOSPITAL, GL_BUILDING_TYPE_ALCHEMIST_SHOP, GL_BUILDING_TYPE_CHURCH_CATH, GL_BUILDING_TYPE_CHURCH_EV, GL_BUILDING_TYPE_BANKHOUSE, GL_BUILDING_TYPE_CRYPT }
			ProtoCount = 6
		else -- rogue
