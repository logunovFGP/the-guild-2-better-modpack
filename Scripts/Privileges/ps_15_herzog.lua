...
function GetCompletePrivilegeList()
	return ps_15_herzog_GetPrivilegeList(), ps_15_herzog_GetOldPrivilegeList()
end

function TakeTitle()
	gameplayformulas_StartHighPriorMusic(MUSIC_POSITIVE_EVENT)
	
	chr_SetNobilityImpactList("TitleHolder", ps_15_herzog_GetPrivilegeList())
	...
	feedback_MessageCharacter("",
						...
						BodyLabel, TitleLabel, BuildLabel, maxworkshops, buildingcount, chr_GeneratePrivilegeListLabels(ps_15_herzog_GetCompletePrivilegeList()))
	-- send msg to other dynasties
	feedback_MessageOtherDynastiesTitle("")
end

function LooseTitle()
	chr_RemoveNobilityImpactList("TitleHolder", ps_15_herzog_GetPrivilegeList())
end
