...
function GetCompletePrivilegeList()
	return ps_12_markgraf_GetPrivilegeList(), ps_12_markgraf_GetOldPrivilegeList()
end
...
function TakeTitle()
	...
	local BodyLabel = "@L_CHARACTERS_3_TITLES_AQUIRE_MESSAGES_NEW_BODY_+12"
	
	if SimGetGender("Boss") == GL_GENDER_FEMALE then
		BodyLabel = "@L_CHARACTERS_3_TITLES_AQUIRE_MESSAGES_NEW_FEMALE_BODY_+12"
	end
	
	feedback_MessageCharacter("Boss",
						"@L_CHARACTERS_3_TITLES_AQUIRE_MESSAGES_NEW_PRIVILEGES_HEAD_+0",
						BodyLabel, TitleLabel, BuildLabel, maxworkshops, buildingcount, chr_GeneratePrivilegeListLabels(ps_12_markgraf_GetCompletePrivilegeList()))
