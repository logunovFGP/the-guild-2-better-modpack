...
function GetOldPrivilegeList()
	return "DuelWithOpponent", "CanArrangeLiaison", "RunForAnOffice", "PoliticalAttention"
end
	
function GetCompletePrivilegeList()
	return ps_08_edelmann_GetPrivilegeList(), ps_08_edelmann_GetOldPrivilegeList()
end
...
function TakeTitle()
	...
	local BodyLabel = "@L_CHARACTERS_3_TITLES_AQUIRE_MESSAGES_NEW_BODY_+8"
	
	local GenderLabel = 1
	if SimGetGender("Boss") == GL_GENDER_FEMALE then
		GenderLabel = 2
		BodyLabel = "@L_CHARACTERS_3_TITLES_AQUIRE_MESSAGES_NEW_FEMALE_BODY_+8"
	end
	...
	feedback_MessageCharacter("Boss",
						...
						BodyLabel, TitleLabel, BuildLabel, maxworkshops, buildingcount, chr_GeneratePrivilegeListLabels(ps_08_edelmann_GetCompletePrivilegeList()))
